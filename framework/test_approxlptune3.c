...
float cfpm(float a,float b,int tune)
    ...
    else
    {
        ...
        float b1 = fabs(b);
		int tune = 3;
        float expo_a = floor(log2(a1));
        float expo_b = floor(log2(b1));

        //mantissa
        float man_a = a1/pow(2,expo_a);
        float man_b = b1/pow(2,expo_b);

        // frac
        float frac_a = man_a-1;
        float frac_b = man_b-1;
        // float out;
        float x= frac_a;
        float y= frac_b;
        if (x>=y)
        {
            ...
            if (tune>=2)
            {
                if (x+y>=1)
                {
                    ...
                    if(tune>=3)
                    {
                            if(x+y>=1.5) out = out+0.5*x-0.25;
                            else if(x-y>=0.5) out = out-0.25*x+0.25;
                            else out = out - 0.25*y + 0.125;
                    }
                }
                else 
                {
                    ...
                    if(tune>=3)
                    {
                            if(x-y>=0.5) out = out+0.25*y;
                            else if(x+y<0.5) out = out-0.25*y;
                            else out = out + 0.25*x - 0.125;
                    }
                }
            }
        ...
        else 
        {
            ...
            if (tune>=2)
            {
                if (x+y>=1)
                {
                    ...
                    if(tune>=3)
                    {
                            if(y-x>=0.5) out = out-0.25*y+0.25;
                            else if(x+y>=1.5) out = out+0.25*y-0.25;
                            else out = out -0.25*x + 0.125;
                    }
                }
                else {
                    ...
                    if(tune>=3)
                    {
                            if(y-x>=0.5) out = out+0.25*x;
                            else if(x+y<0.5) out = out-0.25*x;
                            else out = out + 0.25*y - 0.125;
                    }
                }
            }
